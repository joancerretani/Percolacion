...
float varianza(float c[], int b);    // calcula la varianza del vector c de tamaño b.
...
int main(){
	...
	for (c=0; c<128; c++){
		...
		var = varianza(P_vec,iteraciones);
		printf("%3i - %f\n",N, var);
...
float varianza(float c[], int b){ // calcula el valor medio del vector c de tamaño b.
